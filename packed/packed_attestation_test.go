...
var (
	...
	basicAttestation2Sig = []byte{
		48, 70, 2, 33, 0, 169, 64, 216, 34, 73, 156, 237, 68, 233, 169, 38, 224, 88, 64, 100, 12, 38, 209, 189, 114, 8, 165, 165, 36, 76, 216, 213,
		150, 35, 186, 77, 176, 2, 33, 0, 224, 51, 243, 129, 43, 14, 40, 176, 33, 128, 196, 241, 76, 222, 253, 81, 4, 237, 32, 100, 70, 155, 26, 31, 115, 190, 68, 142, 9, 24, 218, 61,
	}

	basicAttestation2CredCert = []byte{
		48, 130, 1, 205, 48, 130, 1, 111, 160, 3, 2, 1, 2, 2, 1, 1, 48, 13, 6, 9, 42, 134, 72, 134, 247,
		13, 1, 1, 11, 5, 0, 48, 96, 49, 11, 48, 9, 6, 3, 85, 4, 6, 12, 2, 85, 83, 49, 17, 48, 15, 6, 3, 85, 4,
		10, 12, 8, 67, 104, 114, 111, 109, 105, 117, 109, 49, 34, 48, 32, 6, 3, 85, 4, 11, 12, 25, 65, 117, 116, 104,
		101, 110, 116, 105, 99, 97, 116, 111, 114, 32, 65, 116, 116, 101, 115, 116, 97, 116, 105, 111, 110, 49, 26, 48,
		24, 6, 3, 85, 4, 3, 12, 17, 66, 97, 116, 99, 104, 32, 67, 101, 114, 116, 105, 102, 105, 99, 97, 116, 101, 48, 30,
		23, 13, 49, 55, 48, 55, 49, 52, 48, 50, 52, 48, 48, 48, 90, 23, 13, 52, 48, 48, 56, 49, 53, 48, 53, 51, 49, 51, 57,
		90, 48, 96, 49, 11, 48, 9, 6, 3, 85, 4, 6, 12, 2, 85, 83, 49, 17, 48, 15, 6, 3, 85, 4, 10, 12, 8, 67, 104, 114, 111,
		109, 105, 117, 109, 49, 34, 48, 32, 6, 3, 85, 4, 11, 12, 25, 65, 117, 116, 104, 101, 110, 116, 105, 99, 97, 116, 111,
		114, 32, 65, 116, 116, 101, 115, 116, 97, 116, 105, 111, 110, 49, 26, 48, 24, 6, 3, 85, 4, 3, 12, 17, 66, 97, 116,
		99, 104, 32, 67, 101, 114, 116, 105, 102, 105, 99, 97, 116, 101, 48, 89, 48, 19, 6, 7, 42, 134, 72, 206, 61, 2, 1,
		6, 8, 42, 134, 72, 206, 61, 3, 1, 7, 3, 66, 0, 4, 141, 97, 126, 101, 201, 80, 142, 100, 188, 197, 103, 58, 200,
		42, 103, 153, 218, 60, 20, 70, 104, 44, 37, 140, 70, 63, 255, 223, 88, 223, 210, 250, 62, 108, 55, 139,
		83, 215, 149, 196, 164, 223, 251, 65, 153, 237, 215, 134, 47, 35, 171, 175, 2, 3, 180, 184, 145, 27, 160,
		86, 153, 148, 225, 1, 163, 23, 48, 21, 48, 19, 6, 11, 43, 6, 1, 4, 1, 130, 229, 28, 2, 1, 1, 4, 4, 3, 2, 5,
		32, 48, 13, 6, 9, 42, 134, 72, 134, 247, 13, 1, 1, 11, 5, 0, 3, 73, 0, 48, 70, 2, 33, 0, 159, 31, 135, 66,
		181, 179, 108, 103, 45, 185, 83, 68, 182, 123, 254, 10, 21, 179, 191, 43, 223, 155, 74, 144, 178, 132, 4, 44,
		85, 8, 100, 106, 2, 33, 0, 148, 203, 170, 118, 71, 91, 25, 222, 232, 92, 95, 52, 61, 231, 236, 77, 222,
		178, 86, 231, 218, 193, 170, 210, 120, 96, 70, 112, 28, 151, 74, 84,
	}

	// created by yubikey
	basicAttestation3 = `{
		"id": "Yz_siYcsipE6CpC_mJyKGfH13CdJFhkmpetFzq3suf3u0QMVrocAZLO_faj0nQhR6fXulhOcqnX6sD5nunI0Bg",
		"rawId": "Yz_siYcsipE6CpC_mJyKGfH13CdJFhkmpetFzq3suf3u0QMVrocAZLO_faj0nQhR6fXulhOcqnX6sD5nunI0Bg==",
		"response": {
			"clientDataJSON": "eyJ0eXBlIjoid2ViYXV0aG4uY3JlYXRlIiwiY2hhbGxlbmdlIjoiVWJDcVdzc25rT3dfU24xZ1p6NHY1LXl5YVlnNDExTXdaQ1hRTGtNUnBGWSIsIm9yaWdpbiI6Imh0dHBzOi8vbG9jYWxob3N0Ojg0NDMiLCJjcm9zc09yaWdpbiI6ZmFsc2V9",
			"attestationObject": "o2NmbXRmcGFja2VkZ2F0dFN0bXSjY2FsZyZjc2lnWEcwRQIgB-FgCRGp-N2D-fIx5w0tVhZxtkAdJ7zlv9p8fhcWt6oCIQD17n9WGsrTIKuessUvcnHrgtJOEGjtm7k0wDJ2Fb2u9GN4NWOBWQLAMIICvDCCAaSgAwIBAgIEBMX-_-IXpULpl2A4zSFU5FYS9R_W3GcUyNcJCHk45m9tXNngkGQk1dmYUk8kUwuZyTfk5T8-n3qixgEo2wwajAiBgkrBgEEAYLECgIEFTEuMy42LjEuNC4xLjQxNDgyLjEuMTATBgsrBgEEAYLlHAIBAQQEAwIFIDAhBgsrBgEEAYLlHAEBBAQSBBD4oBHzjApNFYAGFxEfntx9MAwGA1UdEwEB_wQCMAAwDQYJKoZIhvcNAQELBQADggEBAHcYTO91LRoF8wpThdwthvj6wGNxcLAiYqUZXPX-0Db-AGVODSkVvEVSmj-JXmrBzNQel3FW4AupOgbgrJmmcWWEBZyXSpRQtYcl2LTNU0-Iz9WbyHNN1wQJ9ybFwj608xBuoNRC0rG8wgYbMC4usyRadt3dYOVdQi0cfaksVB2VNKnw-ttQUWKoZsPHtuzFx8NlazLQBep1W2T0FCONFEG7x_l-ZcfNhT13azAbaurJ2J0_ff6H0PXJP6h-Obne4xfz0-8ujftWDUSh9oaiVRYf-tgam_tzOKyEU38V2liV11zMyHKWrXiK0AfyDgb58ky2HSrn_AgE5MW_oXg_CXdoYXV0aERhdGFYxEmWDeWIDoxodDQXD2R2YFuP5K65ooYyx5lc87qDHZdjQQAAADH4oBHzjApNFYAGFxEfntx9AEBjP-yJhyyKkToKkL-YnIoZ8fXcJ0kWGSal60XOrey5_e7RAxWuhwBks799qPSdCFHp9e6WE5yqdfqwPme6cjQGpQECAyYgASFYIL3YLi322DO3kKdNvquZvcGliPbb2ian5SJPu9nMidMEIlggJfxHr0T0u9sCTjvVjntQPLQp6KFCk1mihyb2sV-gQu4="
		},
		"type": "public-key"
		}`

	basicAttestation3CredCert = []byte{
		48, 130, 2, 188, 48, 130, 1, 164, 160, 3, 2, 1, 2, 2, 4, 4, 197, 254, 252, 48, 13, 6, 9, 42, 134, 72, 134, 247, 13, 1, 1, 11, 5, 0, 48, 46, 49, 44, 48, 42, 6, 3, 85, 4, 3, 19, 35, 89, 117,
		98, 105, 99, 111, 32, 85, 50, 70, 32, 82, 111, 111, 116, 32, 67, 65, 32, 83, 101, 114, 105, 97, 108, 32, 52, 53, 55, 50, 48, 48, 54, 51, 49, 48, 32, 23, 13, 49, 52, 48, 56, 48, 49, 48, 48,
		48, 48, 48, 48, 90, 24, 15, 50, 48, 53, 48, 48, 57, 48, 52, 48, 48, 48, 48, 48, 48, 90, 48, 109, 49, 11, 48, 9, 6, 3, 85, 4, 6, 19, 2, 83, 69, 49, 18, 48, 16, 6, 3, 85, 4, 10, 12, 9, 89, 117,
		98, 105, 99, 111, 32, 65, 66, 49, 34, 48, 32, 6, 3, 85, 4, 11, 12, 25, 65, 117, 116, 104, 101, 110, 116, 105, 99, 97, 116, 111, 114, 32, 65, 116, 116, 101, 115, 116, 97, 116, 105, 111, 110, 49,
		38, 48, 36, 6, 3, 85, 4, 3, 12, 29, 89, 117, 98, 105, 99, 111, 32, 85, 50, 70, 32, 69, 69, 32, 83, 101, 114, 105, 97, 108, 32, 56, 48, 48, 56, 52, 55, 51, 50, 48, 89, 48, 19, 6, 7, 42, 134, 72,
		206, 61, 2, 1, 6, 8, 42, 134, 72, 206, 61, 3, 1, 7, 3, 66, 0, 4, 28, 216, 218, 118, 17, 163, 245, 239, 31, 136, 94, 149, 11, 166, 93, 128, 227, 52, 133, 83, 145, 88, 75, 212, 127, 91, 113, 156,
		83, 35, 92, 36, 33, 228, 227, 153, 189, 181, 115, 103, 130, 65, 144, 147, 87, 102, 97, 73, 60, 145, 76, 46, 103, 36, 223, 147, 148, 252, 250, 125, 234, 139, 24, 4, 163, 108, 48, 106, 48, 34, 6,
		9, 43, 6, 1, 4, 1, 130, 196, 10, 2, 4, 21, 49, 46, 51, 46, 54, 46, 49, 46, 52, 46, 49, 46, 52, 49, 52, 56, 50, 46, 49, 46, 49, 48, 19, 6, 11, 43, 6, 1, 4, 1, 130, 229, 28, 2, 1, 1, 4, 4, 3, 2,
		5, 32, 48, 33, 6, 11, 43, 6, 1, 4, 1, 130, 229, 28, 1, 1, 4, 4, 18, 4, 16, 248, 160, 17, 243, 140, 10, 77, 21, 128, 6, 23, 17, 31, 158, 220, 125, 48, 12, 6, 3, 85, 29, 19, 1, 1, 255, 4, 2, 48,
		0, 48, 13, 6, 9, 42, 134, 72, 134, 247, 13, 1, 1, 11, 5, 0, 3, 130, 1, 1, 0, 119, 24, 76, 239, 117, 45, 26, 5, 243, 10, 83, 133, 220, 45, 134, 248, 250, 192, 99, 113, 112, 176, 34, 98, 165, 25,
		92, 245, 254, 208, 54, 254, 0, 101, 78, 13, 41, 21, 188, 69, 82, 154, 63, 137, 94, 106, 193, 204, 212, 30, 151, 113, 86, 224, 11, 169, 58, 6, 224, 172, 153, 166, 113, 101, 132, 5, 156, 151, 74,
		148, 80, 181, 135, 37, 216, 180, 205, 83, 79, 136, 207, 213, 155, 200, 115, 77, 215, 4, 9, 247, 38, 197, 194, 62, 180, 243, 16, 110, 160, 212, 66, 210, 177, 188, 194, 6, 27, 48, 46, 46, 179, 36, 90,
		118, 221, 221, 96, 229, 93, 66, 45, 28, 125, 169, 44, 84, 29, 149, 52, 169, 240, 250, 219, 80, 81, 98, 168, 102, 195, 199, 182, 236, 197, 199, 195, 101, 107, 50, 208, 5, 234, 117, 91, 100, 244,
		20, 35, 141, 20, 65, 187, 199, 249, 126, 101, 199, 205, 133, 61, 119, 107, 48, 27, 106, 234, 201, 216, 157, 63, 125, 254, 135, 208, 245, 201, 63, 168, 126, 57, 185, 222, 227, 23, 243, 211, 239,
		46, 141, 251, 86, 13, 68, 161, 246, 134, 162, 85, 22, 31, 250, 216, 26, 155, 251, 115, 56, 172, 132, 83, 127, 21, 218, 88, 149, 215, 92, 204, 200, 114, 150, 173, 120, 138, 208, 7,
		242, 14, 6, 249, 242, 76, 182, 29, 42, 231, 252, 8, 4, 228, 197, 191, 161, 120, 63, 9, 119,
	}

	basicAttestation3Sig = []byte{
		48, 69, 2, 32, 7, 225, 96, 9, 17, 169, 248, 221, 131, 249, 242, 49, 231, 13, 45, 86, 22, 113, 182, 64, 29, 39, 188, 229, 191, 218,
		124, 126, 23, 22, 183, 170, 2, 33, 0, 245, 238, 127, 86, 26, 202, 211, 32, 171, 158, 178, 197, 47, 114, 113, 235, 130, 210, 78, 16,
		104, 237, 155, 185, 52, 192, 50, 118, 21, 189, 174, 244,
	}
...
var parseTests = []parseTest{
	...
	{
		"basic attestation by the data from real-world yubikey",
		[]byte(basicAttestation3),
		x509.ECDSAWithSHA256,
		basicAttestation3Sig,
		parseCertificate(basicAttestation3CredCert),
		nil,
		nil,
	},
	{
...
var verifyTests = []verifyTest{
	...
	{"basic attestation by the data from real-world yubikey", []byte(basicAttestation3), webauthn.AttestationTypeBasic, []*x509.Certificate{parseCertificate(basicAttestation3CredCert)}},
